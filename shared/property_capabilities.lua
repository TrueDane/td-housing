...
function PropertyCapabilities.Normalize(propertyData)
    ...
    local furnitureMode = propertyData.furniture_mode or propertyData.furnitureMode or PropertyCapabilities.FurnitureMode.PLAYER
    ...
    propertyData.storage_data = {
        ...
        maxWeight = positiveInteger(storage.maxWeight or storage.maxweight, positiveInteger(shellStash.maxweight, 100000)),
